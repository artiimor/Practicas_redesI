...
def processARPReply(data,MAC):
    ...
    # extraemos la mac destino del bytearray (6 bytes sin contar el 26)
    ...
    # aniadimos el par ip/mac , son las de destino porque he supuesto que la arp reply responde la misma cabezera pero aniadiendo su propia mac en mac destino
    cache = {ip_destino: mac_destino}
    awaitingResponse = False
    requestedIP = None
